...
/*-----------------------------------------------
              @(target):= _DoubleLinkForwardModel.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__DoubleLinkForwardModel

#else
#  define SWIG_init    init_DoubleLinkForwardModel

#endif
#define SWIG_name    "_DoubleLinkForwardModel"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_simulate(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOOOOOOOOOO:simulate",&obj0,&obj1,&obj2,&obj3,&obj4,&obj5,&obj6,&obj7,&obj8,&obj9,&obj10,&obj11,&obj12)) SWIG_fail;
  {
    npy_intp size[2] = {
      -1, -1 
    };
  ...
  if (!SWIG_IsOK(ecode7)) {
    SWIG_exception_fail(SWIG_ArgError(ecode7), "in method '" "simulate" "', argument " "7"" of type '" "double""'");
  } 
  arg7 = (double)(val7);
  {
    npy_intp size[1] = {
  ...
  }
  {
    ...
    array10 = obj_to_array_contiguous_allow_conversion(obj4,
      NPY_DOUBLE,
      &is_new_object10);
  ...
  ecode14 = SWIG_AsVal_double(obj6, &val14);
  if (!SWIG_IsOK(ecode14)) {
    SWIG_exception_fail(SWIG_ArgError(ecode14), "in method '" "simulate" "', argument " "14"" of type '" "double""'");
  } 
  arg14 = (double)(val14);
  {
    npy_intp size[1] = {
  ...
  if (!SWIG_IsOK(ecode17)) {
    SWIG_exception_fail(SWIG_ArgError(ecode17), "in method '" "simulate" "', argument " "17"" of type '" "double""'");
  } 
  arg17 = (double)(val17);
  ecode18 = SWIG_AsVal_int(obj9, &val18);
  if (!SWIG_IsOK(ecode18)) {
    SWIG_exception_fail(SWIG_ArgError(ecode18), "in method '" "simulate" "', argument " "18"" of type '" "int""'");
  } 
  arg18 = (int)(val18);
  {
    npy_intp size[1] = {
  ...
  simulate(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11,arg12,arg13,arg14,arg15,arg16,arg17,arg18,arg19,arg20,arg21,arg22,arg23,arg24,arg25);
