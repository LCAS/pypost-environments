...
/*-----------------------------------------------
              @(target):= _QuadLinkForwardModel.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__QuadLinkForwardModel

#else
#  define SWIG_init    init_QuadLinkForwardModel

#endif
#define SWIG_name    "_QuadLinkForwardModel"
...
SWIGINTERN PyObject *_wrap_simulate(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOOOOOOO:simulate",&obj0,&obj1,&obj2,&obj3,&obj4,&obj5,&obj6,&obj7,&obj8,&obj9)) SWIG_fail;
  {
    npy_intp size[2] = {
      -1, -1 
    };
  ...
  arg17 = (double)(val17);
  {
    array18 = obj_to_array_no_conversion(obj9, NPY_DOUBLE);
    if (!array18 || !require_dimensions(array18,2) || !require_contiguous(array18)
  ...
  simulate(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11,arg12,arg13,arg14,arg15,arg16,arg17,arg18,arg19,arg20);
